...
import { addMember, createProject, deleteProject, getProjectById, getProjectMembers, getProjects, getUserRole, removeMember, updateMemberRole, updateProject } from "../controllers/project.controller";
...
router.get('/:projectId/getRole', getUserRole)
...
router.patch('/:projectId/update/:memId', checkUserPermission('edit:member'), updateMemberRole)
