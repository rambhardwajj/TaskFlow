    ...
    <nav className="w-full bg-black text-white shadow px-2 sm:px-2">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between h-16">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-semibold hidden sm:inline">Logo</span>
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/login">
            <Button className="cursor-pointer hover:bg-cyan-950">Login</Button>
          </Link>
          <Link to="/signup">
            <Button className="cursor-pointer hover:bg-cyan-950">Signup</Button>
          </Link>
        </div>
      </div>
